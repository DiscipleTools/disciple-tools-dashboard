...
class DT_Dashboard_Plugin_Functions
{
    ...
    public function scripts() {
        ...
        wp_enqueue_style('switchery', 'https://cdnjs.cloudflare.com/ajax/libs/switchery/0.8.2/switchery.min.css');
        ...
        wp_register_script( 'switchery', 'https://cdnjs.cloudflare.com/ajax/libs/switchery/0.8.2/switchery.min.js' );
        wp_enqueue_script( 'dt-dashboard-plugin', plugin_dir_url( __FILE__ ) . 'plugin.js', [
            'switchery',
