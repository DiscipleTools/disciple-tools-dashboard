    ...
    <div class="card">
        <?php $card->render(); ?>
          ...
          <div class="card-move-left"
               onclick="dt_dashboard.moveBack('<?php echo $card->handle; ?>')">
               <i class="fi-arrow-left"></i>
               Move Left</div>
          <div class="card-move-right"
               onclick="dt_dashboard.moveForward('<?php echo $card->handle; ?>')">
               <i class="fi-arrow-right"></i> Move Right
          </div>
          <div class="card-remove"
               onclick="dt_dashboard.remove('<?php echo $card->handle; ?>')">
