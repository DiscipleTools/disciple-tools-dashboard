    ...
    <div class="card">
        <?php $card->render(); ?>
          ...
          <div class="card-footer">
               <span class="card-nav-btn" onclick="toggleCardNav('<?php echo $card->handle; ?>')">x</span>

               <div class="card-nav" id="card-nav-<?php echo $card->handle; ?>">
          <div class="card-move-left"
               onclick="dt_dashboard.moveBack('<?php echo $card->handle; ?>')">< Move Left</div>
          <div class="card-move-right"
               onclick="dt_dashboard.moveForward('<?php echo $card->handle; ?>')">> Move Right</div>
          <div class="card-remove"
               onclick="dt_dashboard.remove('<?php echo $card->handle; ?>')">X Remove Tile</div>
          </div>
          </div>
