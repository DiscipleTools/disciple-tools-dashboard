...
class DT_Dashboard_Plugin {
    ...
    public function register_tiles() {
        ...
        $tiles->register( new DT_Dashboard_Plugin_Tile( 'DT_Dashboard_Plugin_User_Activity', __( 'User Activity', 'disciple-tools-dashboard' ), [ 'priority' => 0 ] ) );
        $tiles->register( new DT_Dashboard_Plugin_Tile( 'DT_Dashboard_Plugin_Active_Contact', __( 'Active Contacts', 'disciple-tools-dashboard' ), [ 'priority' => 3 ] ) );
        $tiles->register( new DT_Dashboard_Plugin_Tile( 'DT_Dashboard_Plugin_Update_Needed', __( 'Update Needed', 'disciple-tools-dashboard' ), [ 'priority' => 2 ] ) );
        $tiles->register( new DT_Dashboard_Plugin_Tile( 'DT_Dashboard_Plugin_Pending_Contacts', __( 'Pending Contacts', 'disciple-tools-dashboard' ), [ 'priority' => 1 ] ) );
        $tiles->register( new DT_Dashboard_Plugin_Tile( 'DT_Dashboard_Plugin_Contact_Workload', __( 'Contact Workload', 'disciple-tools-dashboard' ), [ 'priority' => 4 ] ) );
